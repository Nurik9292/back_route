...
public class StaffUpdateCaseImpl implements StaffUpdateCase {
    ...
    public StaffUpdateCaseImpl(StaffRepository staffRepository, Presenter<OutputStaff, Response<StaffViewModel>> presenter) {
    ...
    public void execute(InputStaff input) {
        ...
        presenter.present(true, staffRepository.update(input));
    }
}
